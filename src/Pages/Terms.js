...
const TermsAndConditions = () => {
  return (
    <div>
      <Header />
      <div className="bg-gradient-to-r from-black to-gray-700 text-white p-4 shadow-xl rounded-lg max-w-4xl mb-10 mt-10 mx-auto">
        <h1 className="text-3xl text-white font-semibold mb-4">
          Terms and Conditions
        </h1>

        <p>Welcome to realvalueenterprises.com!</p>

        <p className="mb-4">
          These terms and conditions outline the rules and regulations for the
          use of Real Value Enterprises's Website, located at{" "}
          <a
            href="https://www.realvalueenterprises.com"
            className="text-blue-500">
            https://www.realvalueenterprises.com
          </a>
          .
        </p>
        ...
        <p className="mb-4">
          ...
          conditions. Do not continue to use realvalueenterprises.com if you do
        ...
        <p className="mb-4">
          ...
          By accessing realvalueenterprises.com, you agreed to use the required
          cookies.
        </p>
        <p className="mb-4 text-justify">
        ...
        <p className="mb-4 text-justify">
          Unless otherwise stated, Real Value Enterprises and/or its licensors
          own the intellectual property rights for all material on Real Value
          Enterprises. All intellectual property rights are reserved. You may
          access this from Real Value Enterprises for your own personal use
          subjected to restrictions set in these terms and conditions.
        </p>
        <p className="text-lg font-bold">You must not:</p>

        <div className="text-justify">
          <li>Republish material from Real Value Enterprises</li>
          <li>
            Sell, rent or sub-license material from Real Value Enterprises
          </li>
          <li>
            Reproduce, duplicate or copy material from Real Value Enterprises
          </li>
          <li>Redistribute content from Real Value Enterprises</li>
        </div>
        ...
        <p className="mb-4 text-justify">
          ...
          information in certain areas of the website. Real Value Enterprises
          ...
          opinions of Real Value Enterprises,its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their
          views and opinions. To the extent permitted by applicable laws, Real
          Value Enterprises shall not be liable for the Comments or for any
        ...
        <p className="mb-4 text-justify">
          Real Value Enterprises reserves the right to monitor all Comments and
        ...
        <p className="mb-4 text-justify">
          ...
          Real Value Enterprises does not filter, edit, publish or review
          Comments prior to their presence on the website. Comments do not
          reflect the views and opinions of Real Value Enterprises,its agents
          ...
          applicable laws, Real Value Enterprises shall not be liable for the
        ...
        <p className="mb-4">
          You hereby grant Real Value Enterprises a non-exclusive license to
        ...
        <p className="mb-4 text-justify">
          ...
          the hyperlink compensates the absence of Real Value Enterprises; and
        ...
        <p className="mb-4 text-justify">
          ...
          sending an e-mail to Real Value Enterprises. Please include your name,
        ...
        <div className="text-justify text-justify">
        ...
        <p className="mb-4 text-justify">
          No use of Real Value Enterprises's logo or other artwork will be
          allowed for linking absent a trademark license agreement.
        </p>
        <h2 className="text-xl font-semibold mt-4">iFrames</h2>
        <p className="mb-4 text-justify">
