    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-justify">
          At Real Values, accessible from www.realvalueenterprises.com, one of
          our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by Real Values and how we use it. If you have additional
          questions or require more information about our Privacy Policy, do not
          hesitate to contact us. Log Files Real Values follows a standard
          ...
          was created with the help of the Privacy Policy Generator. Google
          DoubleClick DART Cookie Google is one of a third-party vendor on our
          site. It also uses cookies, known as DART cookies, to serve ads to our
          site visitors based upon their visit to www.website.com and other
          sites on the internet. However, visitors may choose to decline the use
          of DART cookies by visiting the Google ad and content network Privacy
        ...
        <p className="text-justify">
          ...
          advertising partners of Real Values. Third-party ad servers or ad
          ...
          on Real Values, which are sent directly to users' browser. They
          automatically receive your IP address when this occurs. These
          technologies are used to measure the effectiveness of their
          advertising campaigns and/or to personalize the advertising content
          that you see on websites that you visit. Note that Real Values has no
        ...
        <p className="text-justify">
          Real Values's Privacy Policy does not apply to other advertisers or
        ...
        <p className="text-justify">
          ...
          participate in, and/or monitor and guide their online activity. Real
          Values does not knowingly collect any Personal Identifiable
          ...
          the information that they shared and/or collect in Real Values. This
          ...
          hereby consent to our Privacy Policy and agree to its Terms and
          Conditions.
        </p>
      </div>
